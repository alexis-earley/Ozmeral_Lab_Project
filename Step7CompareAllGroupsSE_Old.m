function Step7CompareAllGroupsSE(dirList, dirNames, outputDir, maxTime)
    ...
    for i = 1:length(condList)
        ...
        for g = 1:length(dirList)
            ...
            subjAvg = squeeze(mean(EEG, 1));  % channels x time
            GFP = std(subjAvg, 0, 1);

            % Calculate SE across subjects' GFPs
            ...
            % Mean GFP line with legend label
